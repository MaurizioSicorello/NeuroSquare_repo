...
% dot product
[RHO, PVAL] = corr(FACES_all_compl.Y, apply_mask(FACES_all_compl, pines, 'pattern_expression', 'ignore_missing'))
[RHO, PVAL] = corr(FACES_all_compl.Y, apply_mask(FACES_all_compl, fearKragel, 'pattern_expression', 'ignore_missing'))
[RHO, PVAL] = corr(FACES_all_compl.Y, apply_mask(FACES_all_compl, angerKragel, 'pattern_expression', 'ignore_missing'))
[RHO, PVAL] = corr(FACES_all_compl.Y, apply_mask(FACES_all_compl, sadnessKragel, 'pattern_expression', 'ignore_missing'))
[RHO, PVAL] = corr(FACES_all_compl.Y, apply_mask(FACES_all_compl, fearFeng, 'pattern_expression', 'ignore_missing'))
...
[~,~,~,~,stats] = regress(FACES_all_compl.Y, [ones(size(M,1),1), M])
...
corr(FACES_all_compl.Y, amygdala_avrg(1,1).dat) % left hemisphere
corr(FACES_all_compl.Y, amygdala_avrg(1,2).dat) % right hemisphere

% extract average dACC signal
dACC_avrg = extract_roi_averages(FACES_all_compl, whole_dACC_split);
% correlate with neuroticism
corr(FACES_all_compl.Y, dACC_avrg(1,1).dat) % left hemisphere
corr(FACES_all_compl.Y, dACC_avrg(1,2).dat) % right hemisphere

% extract average aInsula signal
aIns_avrg = extract_roi_averages(FACES_all_compl, whole_insula_split);
% correlate with neuroticism
corr(FACES_all_compl.Y, aIns_avrg(1,1).dat) % left hemisphere
corr(FACES_all_compl.Y, aIns_avrg(1,2).dat) % right hemisphere
...
for i=1:size(wholeBrainROIActivity,2)
   ...
   corrOutTest(i) = corr(FACES_half_test.Y, wholeBrainROIActivity(1,i).dat);
