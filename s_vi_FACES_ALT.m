...
AHAB2_corr = AHAB2_corr(:,{'id', 'ER_LookDiff', 'pnsx_pa', 'pnsx_na', 'STAI', 'BDI_TOT', 'NEON', 'NEON1', 'NEON2', 'NEON3', 'NEON4', 'NEON5', 'NEON6', 'NEONX', 'NEOE'});
PIP_corr = PIP_corr(:,{'id', 'ER_LookDiff', 'PA_rescale', 'NA_rescale', 'Trait_Anxiety', 'BDI_total', 'neoN', 'neoN1', 'neoN2', 'neoN3', 'neoN4', 'neoN5', 'neoN6', 'NEONX_empty', 'neoE'});
...
varNames = ['ER_LookDiff'; 'PA'; 'NA'; 'STAI'; 'BDI'; 'neoN']
corrTab = corrTab(:,{'ER_LookDiff'; 'PA'; 'NA'; 'STAI'; 'BDI'; 'neoN'});


corrcoef(corrTab{:,:}, 'Rows','pairwise')
