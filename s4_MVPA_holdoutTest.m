...
%%% test z-scaling voxels
IAPS_NegNeut_all_compl = rescale(IAPS_NegNeut_all_compl, 'zscorevoxels')
...
[r, p] = corr(IAPS_neoN6_test.Y, pattern_exp_values) % r = .191, p = .0551 (two-sided), N = 102
...
trainModelThreshFDR = threshold(apply_mask(trainModel.stats.weight_obj, gray_mask_tight), .05, 'unc', 'k', 50)
write(trainModelThreshFDR, 'thresh', 'fname', 'neoN6_IAPS_LookNeg-vs-LookNeut_train_GM_cente_cv_svr_clust50thresh.nii')

orthviews(fmri_data('neoN6_IAPS_LookNeg-vs-LookNeut_train_GM_cente_cv_svr_clust50thresh.nii'))

max(fmri_data('neoN6_IAPS_LookNeg-vs-LookNeut_train_GM_cente_cv_svr_clust50thresh.nii').dat)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Correlations with process-based signatures
...
apply_mask(neoN6pattern, pines, 'pattern_expression', 'ignore_missing','correlation')
apply_mask(neoN6pattern, fearFeng, 'pattern_expression', 'ignore_missing','correlation')
apply_mask(neoN6pattern, fearKragel, 'pattern_expression', 'ignore_missing','correlation')
apply_mask(neoN6pattern, angerKragel, 'pattern_expression', 'ignore_missing','correlation')
apply_mask(neoN6pattern, sadnessKragel, 'pattern_expression', 'ignore_missing','correlation')
...
neurosynthMask = fmri_data('neoN6_IAPS_LookNeg-vs-LookNeut_train_GM_cente_cv_svr_clust50thresh.nii')
