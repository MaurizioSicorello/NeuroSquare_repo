...
p_load(here, R.matlab, stringr, plyr, ggplot2, caret, BayesFactor, party, cowplot, sjstats, pwr, readxl, grid, psychometric, devEMF, lme4)
...
ggsave(here::here("Figures", "Boxplots_FacetsselfOther.pdf"), device = "pdf")
ggsave(here::here("Figures", "Boxplots_FacetsselfOther.png"), device = "png")
...
netPlot <- ggplot(data=dfnetwork, aes(x=Type, y=value, colour=task)) +
  ...
  lesDat <- rbind(c("Full Model", 0.17, 0.046), c("Sparse Mask", 0.16, 0.11), lesDat)
...
ggsave(here::here("Figures", "Lesions.png"))  
