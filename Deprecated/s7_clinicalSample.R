#################################################
# IMPORTANT NOTE
# The code used here is the same as that used in Sicorello et al. (2021)
# To make it easier applicable, the novel vulnerability pattern is called "PINES",
# making less code changes necessary
...
brms::bayes_factor(MEGAbetweenModelBayes_null, MEGAbetweenModelBayes)$bf
